...
@tile_active_window@ a python script for tiling the currently active window into some preset locations on the screen. It uses the @wmctrl@ Linux utility to resize and move windows and the @xbindkeys@ utility to bind itself to keyboard shortcuts.
